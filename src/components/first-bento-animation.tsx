...
export function ReasoningBasic() {
  const reasoningText = `Basandomi sui tuoi dati di mercato e obiettivi, raccomando di concentrare la strategia su Instagram e LinkedIn. Questi canali hanno il miglior ROI per il tuo settore e permettono di raggiungere il target più qualificato.`;
    ...
    >
      ...
      >
        <div className="flex items-end justify-end gap-3">
          ...
          >
            <p className="text-sm">
              Ciao, ho bisogno di aiuto per creare una strategia di marketing efficace per la mia azienda. Quali canali mi consigli per raggiungere i miei obiettivi?
            </p>
          </motion.div>
